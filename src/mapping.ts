        ...
        for(let i = 0; i < data.entries.length; i++){
          ...
          switch (true) {
            ...
            case key == 'allowance':
              ...
              break
            case key == 'methods':
              let methodsToArray= data.entries[i].value.toArray()
              if (methodsToArray.length > 0) {
                for(let i = 0; i < methodsToArray.length; i++){
                  logs.methods.push(methodsToArray[i].toString());
                }
              }
              else 
              {logs.methods.push(methodsToArray.toString()) 
              }
              break
            case key == 'time': 
